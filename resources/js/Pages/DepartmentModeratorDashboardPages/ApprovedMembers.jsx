...
export default function ApprovedMembers({
    ...
    // সার্চ ইনপুট পরিবর্তন হলে ইনারশিয়া রিকুয়েস্ট পাঠানো (Debounced)
    useEffect(() => {
        ...
        const delayDebounceFn = setTimeout(() => {
            router.get(
                route("department-moderator.approved-members"), // আপনার রাউট নাম অনুযায়ী এটি নিশ্চিত করুন
                { search },
                {
                    preserveState: true,
                    replace: true,
        ...
        <AuthenticatedLayout authUser={user}>
            ...
            <div className="max-w-7xl mx-auto py-10 px-4 space-y-8 text-black">
                ...
                <div className="border-b-4 border-black pb-4 mb-6">
                    <h1 className="text-3xl font-black uppercase tracking-tighter text-green-500">
                        Approved Members
                    </h1>
