...
export default function UserDetails({ user = {}, targetUser = {} }) {
    const handleMakeUniversityModerator = () => {
        Swal.fire({
            title: "Are you sure?",
            text: "This action will grant University Moderator privileges to this user.",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                router.get(
                    route("admin.make-university-moderator", targetUser.id),
                    {
                        onSuccess: () => {
                            Swal.fire({
                                title: "Successfully made University Moderator!",
                                icon: "success",
                                draggable: false,
                            });
                        },
                        onError: () => {
                            Swal.fire({
                                title: "Failed to make University Moderator!",
    ...
    const handleRemoveUniversityModerator = () => {
        Swal.fire({
            title: "Are you sure?",
            text: "This action will remove University Moderator privileges from this user.",
            icon: "warning",
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                router.get(
                    route("admin.remove-university-moderator", targetUser.id),
                    {
                        onSuccess: () => {
                            Swal.fire({
                                title: "Successfully removed University Moderator!",
                                icon: "success",
                                draggable: false,
                            });
                        },
                        onError: () => {
                            Swal.fire({
                                title: "Failed to remove University Moderator!",
                                text: "Please try again.",
                                icon: "error",
                                draggable: false,
                            });
